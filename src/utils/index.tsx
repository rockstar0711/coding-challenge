...
// Due to interacting with big numbers, we can use BigNumber utility of ethers library. 
// But currently, we don't need to do any operation with it so just do it like this.
...
// Regarding with time things, we can use the moment library.
